...
const unlockContract = new web3.eth.Contract(
  UnlockABI,
...
function Streams({ currentAccount }) {
  ...
  const createStreamSubmit = async () => {
    ...
    instance.defaults.headers.common[
      'Authorization'
    ] = `Token ${process.env.REACT_APP_VOODFY_ACCESS_TOKEN}`
    instance
  ...
  const makeSuperAppLockManager = async (lockAddress, videoId) => {
    ...
    PublicLockContract.methods
      .addLockManager(process.env.REACT_APP_SUPERAPP_ADDRESS)
      .send({ from: currentAccount })
      .then(async (receipt) => {
        ...
        let stream = {
          ...
          pubsubTopic: videoId,
          streamUrl: `https://embed.voodfy.com/${videoId}`,
  ...
  return (
    <VStack width="100%">
      <HStack width="100%">
        ...
        <Spacer />
        <Button isLoading={isPageLoading} colorScheme="pink" onClick={onOpen}>
          + Create A Stream
        </Button>
      </HStack>
      <Divider color="pink" />
              ...
              <ModalBody>
                <VStack alignItems="flex-start" spacing={5}>
                  ...
                  <Box alignSelf="center">
                    <Tag backgroundColor="rgba(230,1,122,0.08)" color="#E6017A">
                      This is the only time you will see the stream key.
                    </Tag>
                  </Box>
                </VStack>
              </ModalBody>
                ...
                <VStack spacing={3}>
                  ...
                  <FormControl id="name" isRequired>
                    ...
                    <Input
                      ...
                      value={streamTitle}
                      onChange={(e) => handleInput(e, setStreamTitle)}
                    />
                  </FormControl>
                  <FormControl id="description" isRequired>
                    ...
                    <Textarea
                      ...
                      onChange={(e) => handleInput(e, setStreamDescription)}
                      focusBorderColor="pink.500"
                    />
                  </FormControl>
              ...
              <ModalFooter>
                <HStack width="100%">
                  <Button
                    ...
                    isLoading={creatingStream}
                    onClick={createStreamSubmit}
                    colorScheme="pink"
                  >
                    Create Stream
                  </Button>
