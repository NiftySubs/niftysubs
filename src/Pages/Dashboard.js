        ...
        <HStack py="50px" px="100px">
            <Router>
                ...
                <VStack alignItems="flex-start">
                    ...
                    <Button width="200px" variant="ghost" leftIcon={<RiMoneyDollarCircleFill />}>Flows</Button>
                    <Link to={`${url}/superchats`}><Button width="200px" variant="ghost" leftIcon={<RiChatHeartFill />}>SuperChats</Button></Link>
                    <Button width="200px" variant="ghost" leftIcon={<RiSignalTowerFill />}>Streams</Button>
                </VStack>
                <VStack>
