import { HStack, VStack, Button, Tag } from '@chakra-ui/react'
      ...
      {currentAccount ? (
        <Router>
          <VStack alignItems="flex-start">
            ...
            <Link to={`${url}/superchats`}>
              <Button
                colorScheme={
                  window.location.pathname == `${url}/superchats` ? 'pink' : ''
                }
                justifyContent="flex-start"
                width="200px"
                variant="ghost"
                leftIcon={<RiChatHeartFill />}
              >
                SuperChats
              </Button>
            </Link>
            <Link to={`${url}/fundraisers`}>
              <Button
                colorScheme={
                  window.location.pathname == `${url}/fundraisers` ? 'pink' : ''
                }
                justifyContent="flex-start"
                width="200px"
                variant="ghost"
